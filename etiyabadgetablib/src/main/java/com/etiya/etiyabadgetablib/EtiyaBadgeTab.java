...
package com.etiya.etiyabadgetablib;
...
public class EtiyaBadgeTab extends TabLayout {
    ...
    public static final class EtiyaBadgeTabBuilder {
         ...
         */
        public EtiyaBadgeTabBuilder tabBadge(boolean isBadge) {
            mIsBadge = isBadge;
            return this;
        }
         ...
         * @return Deger set edilmis nesneyi dondurur.
         */
        public EtiyaBadgeTabBuilder tabTitleColor(Integer color) {
         ...
         * @return Deger set edilmis nesneyi dondurur.
         */
        public EtiyaBadgeTabBuilder tabBadgeCount(int count) {
            mBadgeCount = count;
            return this;
        }
         ...
         * @return Deger set edilmis nesneyi dondurur.
         */
        public EtiyaBadgeTabBuilder tabBadgeCountMore(boolean isTabBadgeCountMore) {
         ...
         * @return Deger set edilmis nesneyi dondurur.
         */
        public EtiyaBadgeTabBuilder tabTitle(String tabTitleText) {
         ...
         * @return Deger set edilmis nesneyi dondurur.
         */
        public EtiyaBadgeTabBuilder tabIcon(int drawableRes) {
         ...
         * @return Deger set edilmis nesneyi dondurur.
         */
        public EtiyaBadgeTabBuilder tabIcon(Drawable drawableRes) {
         ...
         * @return Deger set edilmis nesneyi dondurur.
         */
        public EtiyaBadgeTabBuilder tabIconColor(Integer color) {
            mTabIconColor = color;
            return this;
        }
         ...
         * @return Deger set edilmis nesneyi dondurur.
         */
        public EtiyaBadgeTabBuilder tabIconDirection(String tabIconDirectionText) {
         ...
         * @return Deger set edilmis nesneyi dondurur.
         */
        public EtiyaBadgeTabBuilder tabIconToTitle(Integer value) {
         ...
         * @return Deger set edilmis nesneyi dondurur.
         */
        public EtiyaBadgeTabBuilder tabBadgeBgColor(Integer color) {
         ...
         * @return Deger set edilmis nesneyi dondurur.
         */
        public EtiyaBadgeTabBuilder tabBadgeTextColor(Integer color) {
         ...
         * @return Deger set edilmis nesneyi dondurur.
         */
        public EtiyaBadgeTabBuilder tabBadgeCornerRadius(Integer value) {
         ...
         * @return Deger set edilmis nesneyi dondurur.
         */
        public EtiyaBadgeTabBuilder tabBadgeStroke(Integer strokeWidth, Integer strokeColor) {
         ...
         */
        public void createEtiyaBadgeTab() {
            if (mView == null) {
                return;
            }
